...
<html>
	...
	<body background="{{URL::asset('/sekil/pul.jpg')}}" style="font-family: 'Nunito', sans-serif;" onload="yukleme();">
		<div class="boyuk">
			...
			<div class="navbar navbar-expand-lg nav2bar">
				...
				<div class="collapse navbar-collapse" id="togl-item">
					<div class="navbar-nav ml-auto mr-auto">
						<div class="nav-item">
							<a href="{{ '/' }}" class="nav-link linkler activeBtn" id="lang-3" >{{$lang->lang3}}</a>
						</div>
						<div class="nav-item">
							<a href="{{ '/exchange' }}" class="nav-link linkler" id="lang-4">{{ $lang->lang4 }}</a>
						</div>
						<div class="nav-item">
							<a href="{{ '/news' }}" class="nav-link linkler" id="lang-5">{{ $lang->lang5 }}</a>
						</div>
					</div>
				</div>
			</div>
